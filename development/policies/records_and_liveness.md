...
templates for new SPECs, STATUS records, and task prompts.
...
## 2. Forward templates (new steps/tasks only; existing files are records — no retro-edits)

- **SPEC** (`development/specs/SXX_*.md`): Goal · In scope · Out of scope (may be
  ...
  not a statement.
- **STATUS** (`development/records/SXX_*/STATUS.md`): header
  `**Branch:** … · **Date:** … · **State:** …` ·
