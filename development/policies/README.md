...
| `coding-conventions.md` | Python code style: what ruff/mypy enforce, plus the module-only imports, whole-acronym CapWords naming, and Google docstring-section rules the linter can't check |
