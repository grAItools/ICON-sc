...
`policies/document_kinds.md`. Cross-cutting instruments: `policies/` (standing
...
| `records/` | outcome documents frozen at merge, `NNN_<slug>_record{.md,/}`: STATUS files, execution reports, `report-0000-overview.md`, `report-0036-implementation-report.md` |
