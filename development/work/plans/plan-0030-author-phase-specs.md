...
3. `development/work/reports/report-0000-overview.md` §1 (agent contract) and 2–3 EXISTING step folders as
   ...
   and level of detail).
4. `development/work/reports/report-0036-implementation-report.md` §4–§6 — the findings and follow-ups your SPECs
...
- Numbered task ordering starting with **reference mining** (name candidate repos/
  ...
  not trusted, and every source lands in development/references/lock.toml at mining time).
- A `**Pitfalls:**` paragraph. Mine `development/work/reports/report-0036-implementation-report.md` §4 for
...
3. The DAG is stated in every SPEC header and is acyclic; a proposed update to
   `development/work/reports/report-0000-overview.md` §2's mermaid graph is included in your report AS A DIFF
