...
5. Order-verification harness: generic `measure_order(builder, dts, exact)` in `icon_sc.core.testing`; used again in validation/L7 later. Plot artifacts (matplotlib, saved to step artifacts dir) for the human gate — reviewers eyeball the convergence lines.
