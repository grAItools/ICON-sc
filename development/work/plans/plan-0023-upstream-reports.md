...
Source material: `development/records/008_graupel_component_record/STATUS.md` (the leak dossier and
...
Source material: `development/records/013_diffusion_jw_l4_record/STATUS.md` (the root-cause
narrative), `development/records/012_nonhydro_hosting_record/STATUS.md` §5 (the original dossier +
