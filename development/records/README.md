# development/plans/reports — task deliverables index

Three kinds of files live here (taxonomy: `development/archive/plan_tree_map.md` §1). Naming rule
(`development/archive/plan_tree_map.md` §2): flat `NN_<snake>_REPORT.md` for task *execution reports*; a
