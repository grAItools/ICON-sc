...
| TD-33.4 | 2026-07-14 | Proposed revision of `docs/architecture/symcon_repo_layout.md` repo tree (diff artifact `development/records/33_structure_migration/layout_doc_revision.diff`); owner applies or rejects. Marks the re-draft of TD-29.7 | signed-off | `development/plans/33_structure_migration.md` §5.13 | owner-applied, trunk commit `f053659` |
