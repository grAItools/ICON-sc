...
- **matplotlib added to the dev dependency group** (PLAN item 5 requires plot
  ...
  gitignored `plan/steps/S04_coupling_algebra/artifacts/` and regenerate with
...
- `plan/steps/S04_coupling_algebra/artifacts/convergence_ode.png` (acceptance 1)
- `plan/steps/S04_coupling_algebra/artifacts/convergence_burgers.png` (acceptance 2)
