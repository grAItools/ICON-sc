...
1. Read development/work/$ARGUMENTS/spec.md in full if the work unit has a spec,
   then development/work/$ARGUMENTS/plan.md, then AGENTS.md if not already in
...
6. Write the report development/work/$ARGUMENTS/report.md, with artifacts (if any) in development/work/$ARGUMENTS/artifacts/, (template in
